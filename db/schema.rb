...
ActiveRecord::Schema[7.0].define(version: 2023_03_10_122239) do
  ...
  create_table "answered_questions", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["exercise_id"], name: "index_answered_questions_on_exercise_id"
  ...
  create_table "citynames", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.string "title"
    t.string "slug"
    t.uuid "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_citynames_on_user_id"
  end
  ...
  add_foreign_key "answered_questions", "exercises"
  add_foreign_key "answered_questions", "results"
  add_foreign_key "answers", "questions"
  add_foreign_key "articles", "users"
  add_foreign_key "citynames", "users"
