...
class ResultsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create result" do
    assert_difference("Result.count") do
      post results_url, params: { result: { exercise_id: @result.exercise_id, user_id: @result.user_id } }
    end
  ...
  test "should update result" do
    patch result_url(@result), params: { result: { exercise_id: @result.exercise_id, user_id: @result.user_id } }
